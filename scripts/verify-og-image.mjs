...
for (const required of ["pi-ds4 Guide", "v 0.5.4", "96+ GB", "~87", "Headroom128", "622 t/s", "42 t/s", "275 commits", "Jun–Aug 2026"]) {
  if (!ogText.includes(required)) fail(`og-image.html is missing current fact: ${required}`);
}
for (const stale of ["Q2_K", "~99 GB", "87/91", "87/98", "1M", "360 tok/s", "33 tok/s", "xhigh", "99 commits", "152 commits", "239 commits", "265 commits", "545 t/s", "35 t/s", "638 t/s", "37 t/s", "v 0.5.1", "v 0.5.2", "v 0.5.3", "2026-07"]) {
